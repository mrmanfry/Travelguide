...
* Nominare al lettore gli oggetti del nostro sistema. Le parole «brief», «scheda», «blocco», «campo», «outline» non esistono per chi legge: ha compilato un modulo e vi ha raccontato delle cose. Non si scrive «nel brief c'è una nota che teniamo presente», si scrive «ci avete scritto che…», «sappiamo che…», o — meglio ancora — non lo si annuncia affatto e lo si usa e basta. Un libro che cita la propria scheda di lavorazione smette di essere un libro.
